...
from HL_FAF_QC_04_v2w_over_years import FAF_QAQC_04
from HL_FAF_QC_Summary import FAF_QAQC_Summary

# =============================================================================
# user input
# =============================================================================
qaqc_name = "04_v2w_over_years"
...
for measure in ["v2w"]:
    ...
    # qa/qc
    grp_list, dim_list, df_list,df_list_flagged = FAF_QAQC_04(df,year_list,thresholds_by_grp_measure)
