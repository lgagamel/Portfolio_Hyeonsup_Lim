...
from HL_FAF_QC_05_change_of_shares import FAF_QAQC_05
from HL_FAF_QC_Summary import FAF_QAQC_Summary

# =============================================================================
# user input
# =============================================================================
qaqc_name = "05_change_of_shares"
...
for measure in measure_list:
    ...
    # qa/qc
    grp_list, dim_list, df_list,df_list_flagged = FAF_QAQC_05(df,year_list,measure,thresholds_by_grp_measure)
