...
# =============================================================================
def FAF_QAQC_02(df,year_list,measure,thresholds_by_grp_measure):
    ...
    for i,grp in enumerate(grp_list):
        ...
        df_tmp = df.groupby(grp,as_index=False)[measure_columns].sum()
        ...
        # output
        df_tmp = df_tmp[grp+measure_columns+measure_columns_dif+measure_columns_pct+["flag_1","flag_2","flag_3","flag_any"]]
