...
# read data
# =============================================================================
df = pd.read_csv("output/07/truck_port_to_centroid_skim.csv")
...
truck_node_gdf.to_file("output/08/centorids_with_no_ports.shp")
...
df.to_csv("output/08/truck_port_to_centroid_skim_only_feasible.csv",index=False)
