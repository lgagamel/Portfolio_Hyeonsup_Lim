...
# # Load shapefiles
# =============================================================================
port_gdf = gpd.read_file('output/05/ports.shp')
...
link_gdf.to_file('output/06/port_to_water_link.shp')
...
link_gdf.to_file('output/06/port_to_truck_link.shp')
...
# output
# =============================================================================
port_gdf.to_file('output/06/ports_before.shp')
ind = port_gdf["dist_p2t"]<1000
port_gdf = port_gdf.loc[ind]
port_gdf.to_file('output/06/ports.shp')
port_gdf.drop(columns=["geometry"]).to_csv('output/06/ports.csv',index=False)
