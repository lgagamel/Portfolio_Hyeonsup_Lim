...
df_forecast = pd.read_csv('output/step7/scenario1/forecast.csv',dtype=dtype)
df_std = pd.read_csv('output/step7/scenario1/forecast_std_err.csv',dtype=dtype)
# =============================================================================
# index time
# =============================================================================
...
df_out.to_csv('output/step9/scenario1/us_export_forecast.csv',index=False)
