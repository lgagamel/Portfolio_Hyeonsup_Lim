...
df_forecast = pd.read_csv('output/step7/scenario3/forecast.csv',dtype=dtype)
df_std = pd.read_csv('output/step7/scenario3/forecast_std_err.csv',dtype=dtype)
# =============================================================================
# index time
# =============================================================================
...
df_out.to_csv('output/step9/scenario3/us_export_forecast.csv',index=False)
