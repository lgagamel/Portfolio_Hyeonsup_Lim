...
# output
# =============================================================================
df.to_csv('output/step7/scenario0/forecast.csv',index=False)
df_lower.to_csv('output/step7/scenario0/forecast_lower.csv',index=False)
df_upper.to_csv('output/step7/scenario0/forecast_upper.csv',index=False)
df_std_error.to_csv('output/step7/scenario0/forecast_std_err.csv',index=False)
