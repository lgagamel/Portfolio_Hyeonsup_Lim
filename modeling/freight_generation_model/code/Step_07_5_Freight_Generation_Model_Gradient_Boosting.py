...
# Output folder
# =============================================================================
os.chdir('output/step_7/Gradient Boosting')
...
def run_GridSearch(X,y):
    ...
    grid = GridSearchCV(GradientBoostingRegressor(), tuned_parameters)
    grid.fit(X, y)
...
def run_MODEL_sub(X_train,X_test,y_train,y_test, target_measure_max, log_transform_ind, best_params_):
    model = GradientBoostingRegressor(max_depth = best_params_['max_depth'], ccp_alpha = best_params_['ccp_alpha'], n_estimators = best_params_['n_estimators'], learning_rate = best_params_['learning_rate'])
...
outputfile_all.write("model,measure,naics,N,log,attr,par,mae,rmse,r2,max_depth,ccp_alpha,n_estimators,learning_rate\n")
outputfile_summary.write("model,measure,naics,N,log,attr,par,mae,rmse,r2,max_depth,ccp_alpha,n_estimators,learning_rate\n") 

#target_measure = 'value'
model_approach = 'Gradient Boosting'
for target_measure in ['tons','value']:
    ...
    #                df[col] = df[col] + 10e-300
                ...
                outputfile_all.write(",".join([str(model_approach),
                                      ...
                                      str(model_output['learning_rate']),
                                      ])+"\n")
            ...
            print(model_approach,
                  ...
                  "learning_rate:",final_model_selection["model_output"]['learning_rate'],)
            ...
            outputfile_summary.write(",".join([str(model_approach),
                                      ...
                                      str(final_model_selection["model_output"]['learning_rate']),
                                      ])+"\n")
